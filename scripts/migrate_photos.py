#!/usr/bin/env python3
"""
Mac写真.app → Windows 移行スクリプト
/Volumes/SSD/写真ライブラリ.photoslibrary → /Volumes/SUNEAST/photo
"""
...
def migrate_photos():
    ...
    if errors:
        ...
        print("詳細は migration_report.json を確認してください。")

if __name__ == "__main__":
    print("Mac写真ライブラリ → Windows 移行ツール")
    print("=" * 60)
